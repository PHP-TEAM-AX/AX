...
define("API_KEY",$Token); # DEFINE THE TOKEN AS TOKEN TO USE IT INSIDE FUNCTION
...
$url = "https://www.alsh-bg.ml/AX/AX_8.php";
$setwebhook = file_get_contents("https://api.telegram.org/bot$TOKEN/setwebhook?url=".$url);
